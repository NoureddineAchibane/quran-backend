...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:3001", "https://quran-frontend-clyc0edgm-noureddineachibanes-projects.vercel.app", "https://quran-frontend-three.vercel.app/"],
